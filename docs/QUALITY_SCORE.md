...
| Accessibility/security/reliability proof | 1/4 | 3/4 | Light/dark axe-core scans and `tests/e2e/assistive-access.spec.ts` now mechanically prove keyboard dispatch/approval/inspection, truthful lifecycle announcements, completion and modal focus behavior, reduced motion, forced colors, and a fresh 320x800 protocol-touch journey with Files inspection, reopen, no overflow and measured targets at `c0fe7c9a076d7e8877f142975e292529b2118e9c`. The synthetic credential boundary, endpoint/loopback/CORS checks, SSE replay and SQLite recovery also pass; `make test-recovery` proves completed-task API restart and fresh-browser reopen at `8b4b8c9ca404e9e08369440bce4a88fed24d964d`. Actual assistive technology, browser zoom, real devices, Windows High Contrast, active-work/Postgres recovery and the tenant/SSRF abuse pack remain unaccepted. | Complete `E2E-V1-05`, `E2E-V1-08`, and `E2E-V1-09` retained proof |
