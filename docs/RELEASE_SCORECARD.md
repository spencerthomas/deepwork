...
enforcement and its regression tests are pinned at `91a6875`.
...
|---|---|---|---|
| Technical fixture journey | `make test-e2e-demo` | Passing locally: 12 browser tests | API-backed local product behavior, light/dark WCAG scans, keyboard and 320px touch completion, lifecycle/focus behavior, coding review and registry-race protection, two-device stale-decision prevention and post-preflight conflict reconciliation, reduced motion, forced colors and the loopback network contract |
