...
at `8acd3db9dce29ee9b8a20de5363b604315a17ca5`.
...
| `E2E-V1-11-CONTRIBUTOR` | Partial | No | No | No | The supported root `make check` is green: architecture enforcement, formatting, lint, type checks, 80 domain tests, 66 SDK tests, 32 UI tests, 321 web tests, 332 API tests plus 85 API contract tests, 100 agent tests and reproducible package builds all pass. Two independent clean-machine contributor runs, intentional drift repair and license/trademark proof remain open. |
