...
4. **Deep link / desktop integration** — no `dcode://` scheme is documented; should the Tauri app (F21) shell out to dcode or probe PATH for the install nudge? Post-M3, coordinate with F21.
