...
Status: canonical registry; IDs are stable and do not imply passing runtime tests
...
scenarios** section in the accepted Wave 0 snapshot. This table freezes both order and
title. Scenario IDs are indexed into product-spec metadata and a generated
...
[FINAL-PLAN.md](../PLANS.md#11-v1-program-acceptance).
