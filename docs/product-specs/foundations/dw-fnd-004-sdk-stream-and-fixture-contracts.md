...
| The prototype demonstrates rich stream tabs but simulates much behavior. | Prototype evidence at `26c698b` | High | Use it for projection and interaction coverage, not transport authority. |
