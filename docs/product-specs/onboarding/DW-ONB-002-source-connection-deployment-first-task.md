...
|---|---|---|
| The prototype contains a source/deployment-shaped setup story but no real connection or deployment state. | Prototype evidence at `26c698b`; simulated | Reuse layout cues only; build explicit verification and recovery states. |
