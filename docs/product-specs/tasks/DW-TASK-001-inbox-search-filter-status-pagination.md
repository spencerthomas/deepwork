...
|---|---|---|
| The prototype inbox groups fixture tasks, filters by status, toggles grouping, and links to detail. | Prototype evidence at `26c698b`; functional locally over fixtures only | Preserve the scan model while replacing static filtering with URL state and real source queries. |
