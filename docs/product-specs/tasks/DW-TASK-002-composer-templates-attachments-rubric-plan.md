...
|---|---|---|
| The prototype new-task route presents a polished but fixture-backed composer. | Prototype evidence at `26c698b`; simulated | Preserve the low-friction composition flow but add real validation, upload, capability, and idempotency states. |
