...
|---|---|---|
| The prototype renders fixture narration, tool cards, approvals, browser evidence, terminal, run context, and subagent panels. | Prototype evidence at `26c698b`; interactive but simulated | Use it as interaction evidence; define normalized runtime projections and all failure states. |
