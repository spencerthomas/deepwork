...
|---|---|---|
| Prototype fixtures depict a SWE task, research task, browser evidence, changed files, PR, artifacts, and concurrent subagents. | Prototype evidence at `26c698b`; simulated | Preserve review affordances but do not promote fixture progress, browser, or subagent assumptions into contracts. |
