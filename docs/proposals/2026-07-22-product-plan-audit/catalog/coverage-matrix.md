...
Status: staged proposal; not canonical scope
Frontend evidence: `deep-work-frontend@8866d39a2888e358091208063693f260cff6d261`
Vision and roadmap evidence: `deepwork@06f051554bf938e919af5ab7855974098fbf3d2a`
Plan library snapshot: `docs/proposals/2026-07-22-product-plan-audit/plans/` on 2026-07-22
...
the [acceptance-scenario index](acceptance-scenario-index.md). This matrix assigns
...
| ID | Page route and evidence | Current state at `8866d39` | Owner feature ID | Disposition | Planned resolution |
|---|---|---|---|---|---|
...
| U2 | Import frontend and hygiene | `DW-FND-002` | `DW-SURF-001`, `DW-QUAL-001` | Preserve one-way migration from `8866d39`; port tokens/primitives and audited surfaces, not fixtures or guessed contracts. |
...
| R2 | Import prototype as `apps/web` and apply hygiene | `DW-FND-002` | Reframe | Port audited shell/tokens/components one way from `8866d39`; do not import fixture behavior or treat a bulk copy as migration. |
...
disposition in the [acceptance-scenario index](acceptance-scenario-index.md#pinned-canonical-success-criterion-reconciliation).
