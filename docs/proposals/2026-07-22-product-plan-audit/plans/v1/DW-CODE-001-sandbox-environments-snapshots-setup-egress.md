...
|---|---|---|
| Prototype settings and task detail show fixture sandbox, environment, terminal, network, and snapshot concepts. | Prototype evidence at `8866d39`; simulated | Retain the mental model while defining resource ownership and all lifecycle states. |
