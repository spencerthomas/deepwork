...
|---|---|---|
| The prototype shows fixture GitHub connectors, repository/branch context, draft PR, commits, checks, diff, and merge-shaped actions. | Prototype evidence at `8866d39`; simulated | Retain the end-to-end review story, but every GitHub state requires authoritative API/webhook evidence. |
