...
|---|---|---|
| The prototype task view has fixture Files, Diff, Terminal, Browser, run context, PR, and mobile-shaped review interactions. | Prototype evidence at `8866d39`; interactive but simulated | Use layout and interaction as evidence; require real file/diff/session contracts and explicit missing states. |
