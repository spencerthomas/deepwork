...
|---|---|---|
| The prototype approvals page filters fixture shell/write/commit approvals and its action component only changes local state. | Prototype evidence at `8866d39`; simulated | Preserve inbox/card cues but replace the local verbs with the exact HITL contract and real race states. |
