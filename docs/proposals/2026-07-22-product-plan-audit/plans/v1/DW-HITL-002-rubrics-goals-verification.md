...
|---|---|---|
| Prototype settings include goals/rubrics and fixture subagents reference a critic, but no runtime evaluation is wired. | Prototype evidence at `8866d39`; simulated | Keep task-scoped goal/rubric concepts; replace mock scores with attributable verdict records. |
