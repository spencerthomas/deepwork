...
|---|---|---:|---|
| The prototype at `8866d39` is rich interaction evidence but includes simulated/inert controls and incomplete responsive/failure states. | Direct repository audit | High | Screenshots and happy-path component tests cannot qualify release. |
