...
|---|---|---:|---|
| The prototype at `8866d39` contains desktop-oriented shell, composer, run panels, approvals, files, browser, diff, and settings concepts, but limited proven responsive behavior. | Prototype interaction evidence | High | Inventory and adapt every action; do not treat desktop rendering as mobile coverage. |
