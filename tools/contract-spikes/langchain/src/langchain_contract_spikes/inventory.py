...
def build_inventory() -> dict[str, object]:
    ...
    candidate_versions = {name: installed[name] for name in installed if name != "pytest"}
    return {
        "schema_version": "1.0",
        ...
        "packages": {
            ...
            "installed_public_distributions": installed,
            "blocker": None,
        },
        ...
        "live_context": {
            ...
            "sdk": f"langgraph-sdk=={installed['langgraph-sdk']}",
